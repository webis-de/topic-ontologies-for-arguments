...
def preprocess():
    corpus_path = get_path_source("upotsdam-arg-microtexts-v1")
    preprocessed_documents_path = get_path_preprocessed_documents("upotsdam-arg-microtexts-v1")
    path_topics = get_path_preprocessed_topics('upotsdam-arg-microtexts-v1')
    path_document_topic=get_path_document_topic('upotsdam-arg-microtexts-v1')
    documents =[]
    document_ids = []
    topics=[]
